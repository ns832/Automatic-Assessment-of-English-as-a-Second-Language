...
parser.add_argument('--resps_path', type=str, help='Path to responses')
...
with open(args.prompt_ids_path) as f0, open(args.resps_path) as f1, open(args.prompts_path) as f2, open(args.targets_path) as f3:
    resps, prompts, prompt_ids = [], [], []
    target_list = []
    question_ids, responses, questions = f0.readlines(), f1.readlines(), f2.readlines()
